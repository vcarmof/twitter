...
class TweetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tweet" do
    assert_difference('Tweet.count') do
      post tweets_url, params: { tweet: { content: @tweet.content, retweet: @tweet.retweet } }
    end
  ...
  test "should update tweet" do
    patch tweet_url(@tweet), params: { tweet: { content: @tweet.content, retweet: @tweet.retweet } }
